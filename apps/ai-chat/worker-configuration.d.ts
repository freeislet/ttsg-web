/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7225df8389f6bad81261d340d775fd24)
// Runtime types generated with workerd@1.20250902.0 2025-04-04 
declare namespace Cloudflare {
	interface Env {
		VITE_TTSG_BASE_URL: string;
		GEMINI_API_KEY: string;
		CHAT_ROOM: DurableObjectNamespace<import("./workers/app").ChatRoom>;
	}
}
