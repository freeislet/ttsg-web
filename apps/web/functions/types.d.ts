/* eslint-disable */
// Generated by Wrangler by running `wrangler types --path=./functions/types.d.ts` (hash: c7bc7fde598a5a8ef2d17e4ffc1d61ae)
// Runtime types generated with workerd@1.20250730.0 2025-07-30 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		VITE_API_PROXY_ENABLED: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_API_PROXY_ENABLED" | "VITE_API_PROXY_PORT">> {}
}
