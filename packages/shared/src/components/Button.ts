...
export function getButtonClasses(props: ButtonProps): string {
  ...
  // Base classes
  let classes = 'inline-flex items-center justify-center rounded-md font-medium focus:outline-none focus:ring-2 focus:ring-offset-2';
  ...
  if (variant === 'primary') {
    ...
    classes += ' bg-transparent border border-gray-300 text-gray-700 hover:bg-gray-50 focus:ring-blue-500';
  }
